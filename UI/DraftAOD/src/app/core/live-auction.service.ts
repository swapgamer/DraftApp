...
export class LiveAuctionService {
  ...
  resume(lotId:string,durationSeconds:number){return this.http.post<LiveAuctionLot>(`${this.base}/admin/lots/${lotId}/resume`,{durationSeconds}).pipe(map(lot=>this.lotImage(lot)));}
