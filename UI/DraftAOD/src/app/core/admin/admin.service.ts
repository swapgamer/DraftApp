...
export interface AdminUser { id: string; email: string; displayName: string; isActive: boolean; roles: string[]; createdAtUtc: string; }
...
export class AdminService {
  ...
  setUserRole(id: string, roleId: number) { return this.http.put<void>(`${environment.apiUrl}/admin/users/${id}/role`, { roleId }); }
